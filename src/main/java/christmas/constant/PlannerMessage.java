...
public enum PlannerMessage {
    ...
    ORDER_DETAILS_MESSAGE("%s %,d" + MENU_UNIT.getSymbol()),
    OUTPUT_TOTAL_ORDER_AMOUNT_BEFORE_DISCOUNT_TITLE_MESSAGE("<할인 전 총주문 금액>"),
    TOTAL_ORDER_AMOUNT_BEFORE_DISCOUNT_MESSAGE("%,d" + PRICE_UNIT.getSymbol()),
    OUTPUT_GIVEAWAY_MENU_TITLE_MESSAGE("<증정 메뉴>"),
    GIVEAWAY_MENU_MESSAGE("%s %,d" + MENU_UNIT.getSymbol()),
    OUTPUT_BENEFIT_DETAILS_TITLE_MESSAGE("<혜택 내역>"),
    BENEFIT_DETAILS_MESSAGE("%s" + COLON_SPACE.getSymbol() + "%,d" + MENU_UNIT.getSymbol()),
    OUTPUT_TOTAL_BENEFIT_AMOUNT_TITLE_MESSAGE("<총혜택 금액>"),
    TOTAL_BENEFIT_AMOUNT_MESSAGE("%,d" + PRICE_UNIT.getSymbol()),
    OUTPUT_TOTAL_EXPECTED_PAYMENT_AFTER_DISCOUNT_TITLE_MESSAGE("<할인 후 예상 결제 금액>"),
    TOTAL_EXPECTED_PAYMENT_AFTER_DISCOUNT_MESSAGE("%,d" + PRICE_UNIT.getSymbol()),
